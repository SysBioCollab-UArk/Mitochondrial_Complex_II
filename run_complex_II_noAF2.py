...
sim_protocol = SequentialInjections(solver, t_equil=100, time_perturb_value={0: ("Dicarb(a=None)", 10000)})
...
exp_data_file = os.path.join('Data', 'OLD', 'Complex_II_Experiment_Data_NoAF2.csv')
